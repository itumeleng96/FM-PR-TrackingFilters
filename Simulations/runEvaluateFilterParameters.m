...
multiTargetTracker1 = multiTargetTracker(confirmationThreshold,deletionThreshold,gatingThreshold,7);
multiTargetTracker2 = multiTargetTracker(confirmationThreshold,deletionThreshold,gatingThreshold,12);
multiTargetTracker3 = multiTargetTracker(confirmationThreshold,deletionThreshold,gatingThreshold,13);
multiTargetTracker4 = multiTargetTracker(confirmationThreshold,deletionThreshold,gatingThreshold,14);
...
title('Unscented Kalman Filter with varying Beta','Fontsize', 18);
axis xy;
xlabel('Bistatic Range [km]', 'Fontsize', 18);
ylabel('Bistatic Doppler frequency [Hz]', 'Fontsize', 18);
legend('beta:0.01', 'beta:2', 'beta:4','beta:8', 'Measurement', 'Ground Truth');
