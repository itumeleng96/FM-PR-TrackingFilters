...
% Load simulation data - skip fers regen if h5 files already exist
if ~exist('direct.h5','file') || ~exist('echo.h5','file')
    ...
    system(['env LD_LIBRARY_PATH=' sys_libs ':$LD_LIBRARY_PATH ' fers_bin ' FERS/BackupScenarios/scenario_1_singleFile.fersxml']);
end
