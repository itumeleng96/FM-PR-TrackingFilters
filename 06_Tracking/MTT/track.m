        ...
        function obj = track(trueTrack,predictedTrack,trackId,startTime,confirmation,sampleSinceLastUpdate,numberOfUpdates,filterType)
            ...
            switch filterType
                ...
                case 2
                    ...
                    std_meas=[4.926,0.998];                                 %Standard Deviation of the measurements in the x(Range) and y(Doppler)
                    std_acc=[0.0586,0.1972];                             %Standard Deviation of the process noise x(Range) and y(Doppler)
                ...
                case 4
                    ...
                    std_meas=[1.435,1.9989];                              %Standard Deviation of the measurements in the x and y
                ...
                case 5
                    ...
                    std_meas=[0.9707,0.79739];                                 %Standard Deviation of the measurements in the x(Range) and y(Doppler)
                    UKF_object = unscentedKalmanFilter(dt,std_acc,std_meas(1),std_meas(2),[obj.x_initial(1),0,obj.x_initial(2),0;],1e-4,0,2); %alpha,Kappa,Beta 
                    obj.trackingFilterObject = UKF_object;

                case 6
                    disp("Initializing Covariance Scaling Unscented Kalman Filter");
                    std_acc=[0.26533,1.2];                             %Standard Deviation of the process noise x(Range) and y(Doppler)
                    std_meas=[3.9707,0.4];                                 %Standard Deviation of the measurements in the x(Range) and y(Doppler)
               ...
               case 8
                    ...
                    std_acc=[0.051,0.5];                                     %Standard Deviation of the acceleration in ms^2
                    std_meas=[5.6838,0.7991];                               %Standard Deviation of the measurements in the x and y
                ...
                case 20
                    disp("Initializing Particle Filter");
                    N=10000;                                             %Number of particles
                    std_acc=[2,0.2];                                           %Standard Deviation of the process noise
                    std_meas=[4,1];                                  %Standard Deviation of the measurements in the x and y
                    PF_object = particleFilter(dt,std_acc,std_meas,[obj.x_initial(1);0;obj.x_initial(2);0;],N);
                    obj.trackingFilterObject = PF_object;
                 ...
                 case 9
                    disp("Initializing Unscented Kalman Filter");
                    std_acc=[0.076533,0.09938];                             %Standard Deviation of the process noise x(Range) and y(Doppler)
                    std_meas=[0.9707,0.99739];                                    %Standard Deviation of the measurements in the x(Range) and y(Doppler)
                    UKF_object = unscentedKalmanFilter(dt,std_acc,std_meas(1),std_meas(2),[obj.x_initial(1),0,obj.x_initial(2),0;],1e-3,0,2); %alpha,Kappa,Beta 
                    obj.trackingFilterObject = UKF_object;
                ...
                case 10
                    ...
                    std_acc=[0.076533,0.09938];                             %Standard Deviation of the process noise x(Range) and y(Doppler)
                    std_meas=[0.9707,0.99739];                                    %Standard Deviation of the measurements in the x(Range) and y(Doppler)
                    UKF_object = unscentedKalmanFilter(dt,std_acc,std_meas(1),std_meas(2),[obj.x_initial(1),0,obj.x_initial(2),0;],1e-2,0,2); %alpha,Kappa,Beta 
                    obj.trackingFilterObject = UKF_object;
                case 11
                    disp("Initializing Unscented Kalman Filter");
                    std_acc=[0.076533,0.09938];                             %Standard Deviation of the process noise x(Range) and y(Doppler)
                    std_meas=[0.9707,0.99739];                                 %Standard Deviation of the measurements in the x(Range) and y(Doppler)
                    UKF_object = unscentedKalmanFilter(dt,std_acc,std_meas(1),std_meas(2),[obj.x_initial(1),0,obj.x_initial(2),0;],1e-1,0,2); %alpha,Kappa,Beta 
                    obj.trackingFilterObject = UKF_object;
                ...
                case 12
                    ...
                    std_acc=[0.057027,0.047789];                                     %Standard Deviation of the acceleration in ms^2
                    std_meas=[2.046,0.98];                               %Standard Deviation of the measurements in the x and y
                    RGNF_object = RGNF(dt,std_acc,std_meas(1),std_meas(2),[obj.x_initial(1);0;obj.x_initial(2);0;],100,0.9);
                    obj.trackingFilterObject = RGNF_object;
                case 13
                    disp("Initializing   Recursive Gauss Newton Filter");
