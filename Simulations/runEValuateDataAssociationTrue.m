...
for pfa_index = 1:length(pfa_values)
    ...
    for j = 1:numSimulations
        ...
        totalConfirmedKalman = totalConfirmedKalman + compareTracks(multiTargetTracker1.getConfirmedTracks, {trueData, trueData1}, 0.5, 1, 10, 0.1);
        totalConfirmedUKF = totalConfirmedUKF + compareTracks(multiTargetTracker2.getConfirmedTracks, {trueData, trueData1}, 0.5, 1, 10, 0.1);
        totalConfirmedParticle = totalConfirmedParticle + compareTracks(multiTargetTracker3.getConfirmedTracks, {trueData, trueData1}, 0.5, 1, 10, 0.1);
        totalConfirmedRGNF = totalConfirmedRGNF + compareTracks(multiTargetTracker4.getConfirmedTracks, {trueData, trueData1}, 0.5, 1, 10, 0.1);
    end
