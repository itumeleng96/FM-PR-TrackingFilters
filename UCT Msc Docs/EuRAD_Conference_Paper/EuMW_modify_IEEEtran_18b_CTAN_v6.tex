%
% EuMW_modify_IEEEtran_18b_CTAN_V5.tex
%         created by Causal Productions Pty Ltd, 
%	  http://www.causalproductions.com
%	  info@causalproductions.com
%
%	  This file is Copyright 2017-2023 Causal Productions Pty Ltd.
...
%
% HISTORY
% 20251012 version 6 released
% 20230411 version 5 released
%		- include new URL to IEEE Thesaurus, which replaces the earlier IEEE keyword list document mentioned in version 4.
%		- various minor changes to text for clarification of instructions.
%		- added 2 new WORD styles for formatting of figures.
%		- affiliation marker is now simply superscript in surrounding text and does not specify font size for the marker, which was formerly \footnotesize
% 2018 version 4 released
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\makeatletter

% RFIC: override title font size to 18pt
...
\def\@IEEEauthordefaulttextstyle{\EuMWauthorsize\@IEEEcompsocnotconfonly{\sffamily}\sublargesize}%CP
...
% RFIC: Use Michael Shells suggested fix to reduce the space around emdash following Abstract and Index Terms headings
\def\abstract{\normalfont%
...
%%%%%
% Define \RFICauthorrefmark to allow more flexible marking than the \IEEEauthorrefmark command
...
\DeclareRobustCommand*{\EuMWauthorrefmark}[1]{\raisebox{0pt}[0pt][0pt]{\textsuperscript{#1}}}%
%
