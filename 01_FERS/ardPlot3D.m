function [y, ard_] = ardPlot3D(s1, s2, fs, fd_max, td_max, index, ard, f)
    ...
    ylabel('Bistatic Doppler Frequency [Hz]', 'FontSize', 14);
    zlabel('Amplitude [dB]', 'FontSize', 14);
