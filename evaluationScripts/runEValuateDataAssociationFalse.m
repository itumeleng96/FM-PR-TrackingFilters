...
for pfa_index = 1:length(pfa_values)
    ...
    for j = 1:numSimulations
        ...
        totalConfirmedFalseKalman = totalConfirmedFalseKalman + compareTracks(multiTargetTracker1.getConfirmedTracks, {trueData, trueData1,trueData2}, 0.5, 1, 10, 0.1);
        totalConfirmedFalseUKF = totalConfirmedFalseUKF + compareTracks(multiTargetTracker2.getConfirmedTracks, {trueData, trueData1,trueData2}, 0.5, 1, 10, 0.1);
        totalConfirmedFalseParticle = totalConfirmedFalseParticle + compareTracks(multiTargetTracker3.getConfirmedTracks, {trueData, trueData1,trueData2}, 0.5, 1, 10, 0.1);
        totalConfirmedFalseRGNF = totalConfirmedFalseRGNF + compareTracks(multiTargetTracker4.getConfirmedTracks,{trueData, trueData1,trueData2}, 0.5, 1, 10, 0.1);    
    end
