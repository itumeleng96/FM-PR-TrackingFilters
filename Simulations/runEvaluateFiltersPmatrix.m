...
for i = 1:simulation_time
    ...
    [targetClusters,RDM,rdm_] = ca_cfar(y.',10^-6,fs,dopp_bins,delay,40);                    
...
[doppler_ll_1,range_ll_1,t1]=multiTargetTracker1.calculateLogLikelihoodGroundTruthP(trackId,doppler_ll_1,range_ll_1,dopplerTrueData,rangeTrueData,simulation_time);
[doppler_ll_2,range_ll_2,t2]=multiTargetTracker2.calculateLogLikelihoodGroundTruthP(trackId,doppler_ll_2,range_ll_2,dopplerTrueData,rangeTrueData,simulation_time);
[doppler_ll_3,range_ll_3,t3]=multiTargetTracker3.calculateLogLikelihoodGroundTruthP(trackId,doppler_ll_3,range_ll_3,dopplerTrueData,rangeTrueData,simulation_time);
[doppler_ll_4,range_ll_4,t4]=multiTargetTracker4.calculateLogLikelihoodGroundTruthP(trackId,doppler_ll_4,range_ll_4,dopplerTrueData,rangeTrueData,simulation_time);
...
plot(track_mtt_true(1,:), track_mtt_true(2,:), '*', 'Color', 'k', 'LineWidth', 1.4);


% Tracking filter outputs vs Ground Truth
title('Tracking filter outputs', 'FontSize', 20);
...
hold on;plot(t2, doppler_ll_2, 'r--', 'LineWidth', 1.5);  % Red dashed line
