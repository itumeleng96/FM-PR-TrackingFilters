...
for pfa_index = 1:length(pfa_values)
    ...
    for j = 1:numSimulations
        ...
        totalDeletedKalman = totalDeletedKalman + compareTracks(multiTargetTracker1.getDeletedTracks, {trueData, trueData1}, 0.5, 1, 10, 0.1);
        totalDeletedUKF = totalDeletedUKF + compareTracks(multiTargetTracker2.getDeletedTracks, {trueData, trueData1}, 0.5, 1, 10, 0.1);
        totalDeletedParticle = totalDeletedParticle + compareTracks(multiTargetTracker3.getDeletedTracks, {trueData, trueData1}, 0.5, 1, 10, 0.1);
        totalDeletedRGNF = totalDeletedRGNF + compareTracks(multiTargetTracker4.getDeletedTracks, {trueData, trueData1}, 0.5, 1, 10, 0.1);
    end
